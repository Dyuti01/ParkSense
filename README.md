...
**Impact:** Transforms reactive enforcement into proactive, data-driven. By reasonable ranking of hotspots, authorities can deploy limited resources directly to critical choke-points, improving traffic flow.
